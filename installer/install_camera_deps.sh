#!/bin/bash
set -e
echo "=== Установка зависимостей камеры ==="

sudo apt update
sudo apt install -y v4l-utils qv4l2 xvfb git python3-pip python3-jinja2 libboost-dev openssl libgnutls28-dev libtiff-dev pybind11-dev meson cmake python3-yaml python3-ply libglib2.0-dev libgstreamer-plugins-base1.0-dev
cd ~
